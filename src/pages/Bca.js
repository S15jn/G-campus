          ...
          <main className="my-14 lg:mt-20">
            <div className="flex justify-between items-center ">
              ...
              <h1 className=" text-lg text-center underline underline-offset-2 font-bold leading-tight tracking-tight text-heading  lg:text-3xl">
                Master of Computer Applications (MCA) -5yrs
              </h1>
              <Link
                to="/signup"
                      ...
                      <div className="max-w-xl text-center lg:text-left">
                        <div>
                          ...
                          <p className="max-w-xl text-lg mt-4  tracking-tight text-gray-600">
                            Master of Computer Application is a popular course
                            ...
                            pursuing a career in IT, then a MCA course is a
                        ...
                        <div className="mx-auto mt-6 lg:max-w-7xl">
                          ...
                          >
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                MCA empowers you to be a catalyst for
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                ...
                                begins. MCA opens doors to a plethora of career
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                More than an academic pursuit, MCA is where your
                    ...
                    <div className="mx-auto lg:max-w-7xl">
                      ...
                      >
                        ...
                        <li>
                          ...
                          <div className="mt-2 text-base text-gray-500">
                            Our MCA faculty is a symphony of expertise, with
