          ...
          <div className="mx-auto max-w-6xl">
            <div className="flex flex-col items-center">
              ...
              <h1 className="text-center text-3xl font-semibold text-heading md:max-w-4xl lg:text-5xl xl:text-6xl">
                Welcome to IIPS, for aspiring business and IT leaders!
              </h1>
              <p className="mt-6 max-w-3xl text-xl">
                G-Campus fosters a vibrant and dynamic learning environment
                where students pursuing MCA, BCom Hons, and MTECH degrees.
              </p>
            ...
            <div className="mt-12 md:px-2">
              <img
                ...
                src={college_img1}
                // src="C:\Users\jain\OneDrive\Desktop\G-Campus-main\IIPS.png"
                alt="college"
              />
            </div>
          </div>
          ...
          <div className="container px-5 pt-24 mx-auto">
            <div className="flex flex-col text-center w-full mb-20">
              ...
              <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
                Embark on your academic journey at IIPS and explore our
            ...
            <div className="flex flex-wrap -m-4 text-center">
              ...
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <p className="leading-relaxed">MBA (MS)</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <p className="leading-relaxed">MBA (TA)</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
              ...
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <p className="leading-relaxed">Ph.D Computer Science</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <p className="leading-relaxed">Ph.D Management</p>
                </div>
              </div>
              <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              <div className="flex flex-col rounded-3xl bg-layer-2 p-8">
                ...
                <p className="mt-4 text-lg text-justify">
                  ...
                  prominently on the home page of IIPS. This feature should
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
              <div className="flex flex-col rounded-3xl bg-layer-2 p-8">
                ...
                <p className="mt-4 text-lg text-justify">
                  ...
                  mentions associated with IIPS. By curating content
...
async function loader() {
  const data = { Total: 7, BCOM: 75, MBA: 75, MCA: 75, MTECH:75,PHD:25 };
  try {
